...
description: >
  Maintains the Ho System repository's INDEX.md and frontmatter system. Use this skill
  when adding, removing, or updating documents in the Ho System repository index. Also
  trigger when the user says things like "update the index," "add this to INDEX.md,"
  "fix the frontmatter," or "check the index for errors." This skill is narrowly scoped
  to indexing and metadata — it does not edit document content.
---

# Skill: Ho Tool Index Maintenance
