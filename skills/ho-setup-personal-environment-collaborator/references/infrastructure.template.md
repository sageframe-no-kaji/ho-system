...
The Ho System framework lives at `~/<path-to-framework>/`. The operating discipline that `~/.claude/CLAUDE.md` imports is at `~/<path-to-framework>/practitioner/operating-discipline.md`.
