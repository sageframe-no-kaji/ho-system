...
The ho overview is **not** a per-ho document. Each ho gets its own document at authoring time, written via the ho-authoring skill. The overview is the map. Per-ho documents are the bounded scope for individual sessions.
