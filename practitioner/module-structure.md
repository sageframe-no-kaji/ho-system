...
Modules
operating-discipline.md — The Ho System universal operating discipline. Same content for any Ho practitioner. For tonight: a copy of (or symlink to) practitioner/the-operating-discipline.md from your framework repo. The skill (when built later) holds a canonical copy in its references/ and places it here when run for any practitioner.
