...
[Ho 01](../../examples/kanyo-pilot/ho-01-git-good.md) is a textbook shu-stage ho. It establishes professional project infrastructure (virtual environments, linting, testing, documentation) through step-by-step instruction:
...
[Ho 05.6](../../examples/kanyo-pilot/ho-05_6-architecture-redesign.md) is the clearest ha-stage ho in the Kanyō arc. The learner faced a system that wasn't working (tee-based clip extraction) and instead of debugging it, stepped back to ask: _"What are we actually trying to solve?"_
...
Also notable: [Ho 06](../../examples/kanyo-pilot/ho-06-gui-architecture-planning.md), the GUI architecture planning ho, shows ha-stage thinking applied to a new sub-domain. The learner was designing frontend requirements, evaluating technology choices, and making deployment decisions — work that demanded system-level reasoning, not step-by-step guidance.
...
- **[Ho 06.13 — Arrival Confirmation](../../examples/kanyo-pilot/ho-06_13-arrival-confirmation-system.md):** Multi-frame confirmation system to reduce false positives. Designed, implemented, and tested as a complete feature — self-directed, self-scoped, self-verified.
- **[Ho 06.51 — Cloudflare Tunnel](../../examples/kanyo-pilot/ho-06_51-cloudflare-tunnnel.md):** Infrastructure setup documented as a deployment runbook. Not a learning document — an operational reference written by someone who knows what they're doing and is recording it for repeatability.
...
| Element           | Shu                                                | Ha                                               | Ri                                               |
| ----------------- | -------------------------------------------------- | ------------------------------------------------ | ------------------------------------------------ |
| **Template**      | [Shu Ho Template](../templates/shu-ho-template.md) | [Ha Ho Template](../templates/ha-ho-template.md) | [Ri Ho Template](../templates/ri-ho-template.md) |
...
- **[Ho 0.5 — Tool Mastery](../../examples/kanyo-pilot/ho-0_5-tool-mastery.md):** Orientation. Getting tools installed, environment configured, basic comfort established.
- **[Ho 01 — Git Good](../../examples/kanyo-pilot/ho-01-git-good.md):** Full prescriptive template. Step-by-step project setup. Explicit verification at each stage. 2-hour target. The learner builds foundational habits (virtual environments, linting, testing, commit discipline) through guided practice.
- **[Ho 02 — Falcon Vision](../../examples/kanyo-pilot/ho-02-falcon-vision.md):** Still structured, but the learner's reflections show emerging understanding. "ffmpeg still feels like incantation" is an honest Tier 1 assessment. Confidence 4/5 with specific gaps identified. The learner is engaging with the [tiered understanding model](tiered-understanding.md) as a thinking tool, not just a template section to fill out.
- **[Ho 03 — Live Detection](../../examples/kanyo-pilot/ho-03-live-detection-notification.md):** The shift from batch processing to real-time monitoring. The ho is prescriptive but the problem is harder. The learner encounters real complexity (stream disconnections, error handling, continuous operation) within the safety of the shu structure.
...
- **[Ho 05.7 — State Machine Redesign](../../examples/kanyo-pilot/ho-05_7-state-redesign.md):** Simplified 4 states to 3, removed 938 lines, fixed departure clip bug. Problem → Solution → What Changed → Results.
- **[Ho 05.71 — Stream Outage Fix](../../examples/kanyo-pilot/ho-05_71-stream-outage-fix.md):** Traced a false-departure bug to outage time being counted as absence. Identified the specific line where `total_outage_time = 0` was resetting prematurely, moved the fix into the state machine.
- **[Ho 05.72 — Startup Confirmation](../../examples/kanyo-pilot/ho-05_72-startup-confirmation.md):** Added `PENDING_STARTUP` state, freeze-frame handling, and extended outage recovery. Problem → Solution → Files Changed → State Diagram → Testing. Pure operational reference.
- **[Ho 06.12 — Code Quality Check](../../examples/kanyo-pilot/ho-06_12-admin-gui-code-check.md):** Comprehensive quality sweep finding 5 real bugs and 3 type safety issues. The practitioner is running the same quality tools they learned to use in Ho 01, now as routine maintenance.
- **[Ho 06.13 — Arrival Confirmation](../../examples/kanyo-pilot/ho-06_13-arrival-confirmation-system.md):** Multi-frame confirmation system to reduce false positives. Designed, implemented, and tested as a complete feature — self-directed, self-scoped, self-verified.
- **[Ho 06.51 — Cloudflare Tunnel](../../examples/kanyo-pilot/ho-06_51-cloudflare-tunnnel.md):** Infrastructure setup documented as a deployment runbook. Not a learning document — an operational reference written by someone who knows what they're doing and is recording it for repeatability.
...
| ----- | ------------------------------------------------------------------------------------------ | -------- | ----------------------------------------- |
| 0.5   | [Tool Mastery](../../examples/kanyo-pilot/ho-0_5-tool-mastery.md)                          | Shu      | Orientation, setup                        |
| 01    | [Git Good](../../examples/kanyo-pilot/ho-01-git-good.md)                                   | Shu      | Step-by-step, full template               |
| 02    | [Falcon Vision](../../examples/kanyo-pilot/ho-02-falcon-vision.md)                         | Shu      | Structured, but reflections deepen        |
| 03    | [Live Detection](../../examples/kanyo-pilot/ho-03-live-detection-notification.md)          | Shu      | Prescriptive, harder problems             |
| 04    | [Docker Deploy](../../examples/kanyo-pilot/ho-04-docker-deploy.md)                         | Shu      | New domain (DevOps), back to basics       |
| 05    | [Deployment Verification](../../examples/kanyo-pilot/ho-05-deployment-verification.md)     | Shu → Ha | Verifying own work, operational focus     |
| 05.5  | [Dev Testing Strategy](../../examples/kanyo-pilot/ho-05_5-dev-testing.md)                  | Ha       | Self-directed process improvement         |
| 05.6  | [Architecture Redesign](../../examples/kanyo-pilot/ho-05_6-architecture-redesign.md)       | Ha       | Tradeoff analysis, architectural judgment |
| 05.7  | [State Machine Redesign](../../examples/kanyo-pilot/ho-05_7-state-redesign.md)             | Ha → Ri  | Major simplification, self-directed       |
| 05.71 | [Stream Outage Fix](../../examples/kanyo-pilot/ho-05_71-stream-outage-fix.md)              | Ri       | Targeted debugging                        |
| 05.72 | [Startup Confirmation](../../examples/kanyo-pilot/ho-05_72-startup-confirmation.md)        | Ri       | Feature design and implementation         |
| 06    | [GUI Architecture](../../examples/kanyo-pilot/ho-06-gui-architecture-planning.md)          | Ha       | Requirements analysis, tech evaluation    |
| 06.1  | [Admin GUI Implementation](../../examples/kanyo-pilot/ho-06_1-admin-gui-implementation.md) | Ha       | Large build, collaborative                |
| 06.12 | [Code Quality Check](../../examples/kanyo-pilot/ho-06_12-admin-gui-code-check.md)          | Ri       | Routine maintenance                       |
| 06.13 | [Arrival Confirmation](../../examples/kanyo-pilot/ho-06_13-arrival-confirmation-system.md) | Ri       | Self-directed feature                     |
| 06.5  | [Public Viewer](../../examples/kanyo-pilot/ho-06_5-public-viewer-web-gui.md)               | Ha       | Substantial new build                     |
| 06.51 | [Cloudflare Tunnel](../../examples/kanyo-pilot/ho-06_51-cloudflare-tunnnel.md)             | Ri       | Infrastructure setup                      |
| 07    | [YOLO Training](../../examples/kanyo-pilot/ho-07-yolo-training.md)                         | Ha       | New domain (ML), planning mode            |
...
- [Kamae: Project Framing](kamae-project-framing.md) — The pre-ho phase that structures the project
- [The Ho as Unit of Work](ho-structure.md) — Detailed specification of what a ho is
- [The Project Arc](project-arc.md) — How hos sequence into complete project arcs
- [Tiered Understanding](tiered-understanding.md) — The three-tier comprehension model
- [Shu Ho Template](../templates/shu-ho-template.md) — Full prescriptive template for shu-stage hos
- [Ha Ho Template](../templates/ha-ho-template.md) — Flexible template for ha-stage hos
- [Ri Ho Template](../templates/ri-ho-template.md) — Minimal format for ri-stage operational tasks
